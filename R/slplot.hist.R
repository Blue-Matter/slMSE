...
slplot.hist = function(obj, scol = c("red","green","blue","black","darkgrey","purple"),labcex = 0.7,Bdenom=1E3,recdenom=1E6){

  i = 1
  ylabline = 2; xlabline = 2
  par(mfrow=c(4,5),mai=c(0.4,0.4,0.15,0.05))
